export const statesAndDistricts = {
    "Andhra Pradesh": [
      ...
      "YSR District", "Alluri Sitarama Raju", "Anakapalli", "Bapatla", "Eluru", "Kakinada", 
      "Konaseema", "Manyam", "NTR District", "Palnadu", "Tirupati"
    ],
    "Arunachal Pradesh": [
    ...
    "Nagaland": [
      ...
      "Phek", "Tuensang", "Wokha", "Zunheboto", "Noklak"
    ],
    "Odisha": [
    ...
    "Punjab": [
      ...
      "Sahibzada Ajit Singh Nagar", "Sangrur", "Tarn Taran", "Malerkotla"
    ],
    "Rajasthan": [
...
// List of states where LWF is applicable
export const lwfStates = [
  "Maharashtra",
  "Karnataka",
  "Gujarat",
  "West Bengal",
